...
IMPLICIT NONE
  ...
  CHARACTER(LEN=*),PARAMETER:: VERSION=" 1.7 (18 July 2017)"
...
!-------------------------------------------------------------------------------
  ...
  WRITE(efu,*) ' by Ralph Carmichael, '// &
    '<a href="mailto:pdaerowebmaster@gmail.com">pdaerowebmaster AT gmail DOT com</a>'
  WRITE(efu,*) '</address></footer>'
  RETURN
...
! ------------------------------------------------------------------------------
  ...
  WRITE(HTML,*) '<body>'
  WRITE(HTML,*) '<p id="TopMeanLines"></p>'
